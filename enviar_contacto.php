...
// ============================
// OPCIÓN 1: Usando mail() de PHP (básica)
// ============================
function enviarConMailPHP($destino, $nombreRemitente, $emailRemitente, $asunto, $mensaje)
{
    try {
        ...
        registrarLog("DEBUG: Enviando email a {$destino}");
        registrarLog("Headers: " . str_replace("\r\n", " | ", $headers));
        ...
        if ($enviado) {
            registrarLog("SUCCESS: Email enviado a {$destino}");
        } else {
            registrarLog("ERROR: mail() retornó false para {$destino}");
        }
...
// ============================
// OPCIÓN 2: Usando PHPMailer (RECOMENDADO para producción)
// ============================
/*
function enviarConPHPMailer($destino, $nombreRemitente, $emailRemitente, $asunto, $mensaje) {
    ...
    try {
        ...
        $mail->Body = "Has recibido un nuevo mensaje de contacto:\n\n" .
                      ...
                      "Mensaje:\n{$mensaje}\n\n" .
                      "---\n" .
                      "Este mensaje fue enviado desde la plataforma de contratación tecnológica.";
...
try {
    ...
    enviarRespuesta(
        false,
        '',
        'Error al procesar tu solicitud: ' . $e->getMessage()
    );
}
